...
export const Bath = ({
  ...
  console.log("Bath", getAllProduct);
  let filterBathFunc = getAllProduct.filter((value) => value.category_id == 4);
  console.log(filterBathFunc);
  ...
  return (
    <>
      <Navbar />
      <div className="bath_section">
        <div className="bath_banner_section">
          <h1>Bath</h1>
