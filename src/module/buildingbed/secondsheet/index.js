...
export const SecondSheet = ({setSecondFittedSheet, setbedType}) => {
    ...
    <div className="duvet_cover">
      <div className="nested_duvet_Cover">
            ...
            <ul>
              ...
              <li
                ...
                onClick={() => {
                  ...
                  setSecondFittedSheet("#AD542D");
                }}
                // onClick={() => setSecondFittedSheet("#AD542D")}
              >
        ...
        <div className="btn_next">
          <button onClick={() => setbedType("CoverLet")}>Next Step</button>
        </div>
      </div>
    </div>
  );
