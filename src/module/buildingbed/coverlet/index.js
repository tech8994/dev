...
export const CoverLet = ({ setCoverLet, setbedType }) => {
...
<div className="duvet_cover">
      <div className="nested_duvet_Cover">
        ...
        <div className="btn_next">
          <button onClick={() => setbedType("Duvet Cover")}>Next Step</button>
        </div>
      </div>
    </div>
  )
