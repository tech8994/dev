...
import img1 from "../../../assest/images/clothing/stripes/swatch-olive-stripe.jpg";
import img2 from "../../../assest/images/clothing/stripes/swatch-pinstripe.jpg";
import img3 from "../../../assest/images/clothing/stripes/swatch-rust-stripe.jpg";

export const DuvetCover = ({ setColorValue, setbedType }) => {
    ...
    <div className="duvet_cover">
      <div className="nested_duvet_Cover">
        ...
        <div className="btn_next">
          <button onClick={() => setbedType("Summary")}>Next Step</button>
        </div>
      </div>
    </div>
  );
