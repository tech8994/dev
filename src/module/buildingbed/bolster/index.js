...
export const Bolster = ({ setBolster, setbedType }) => {
  const [value, setValue] = useState("");
  const [changeColor, setChangeColor] = useState("");

  return (
    <div className="bolster">
      <div className="nested_bolster">
        ...
        <div className="btn_next">
          <button onClick={() => setbedType("Fitted Sheet")}>Next Step</button>
        </div>
      </div>
    </div>
  );
