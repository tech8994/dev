...
export const SecondPillowcases = ({ setSecondPillowcases, setbedType }) => {
    ...
    <div className="duvet_cover">
      <div className="nested_duvet_Cover">
          ...
          <div className="selecting_section">
            <ul>
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_cacao");
                  setSecondPillowcases("#543230");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_charcoal");
                  setSecondPillowcases("#252129");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_fog");
                  setSecondPillowcases("#C0BEC1");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_lavender");
                  setSecondPillowcases("#CAB0B9");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_lilac");
                  setSecondPillowcases("#D4CAD5");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_limoncello");
                  setSecondPillowcases("#E7D9B6");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_olive");
                  setSecondPillowcases("#323A23");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_petrol");
                  setSecondPillowcases("#305663");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_pink_clay");
                  setSecondPillowcases("#A05551");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_oatmeal");
                  setSecondPillowcases("#D5CCC3");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_rosewater");
                  setSecondPillowcases("#EEE4E5");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_rust");
                  setSecondPillowcases("#AD542D");
                }}
                // onClick={() => setSecondPillowcases("#AD542D")}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_sage");
                  setSecondPillowcases("#C5C6BE");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_terracotta");
                  setSecondPillowcases("#DFBFA8");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_turmeric");
                  setSecondPillowcases("#A06300");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_white");
                  setSecondPillowcases("#EFEFF1");
                }}
              >
              ...
              <li
                ...
                onClick={() => {
                  setChangeColor("swatch_wildflower");
                  setSecondPillowcases("#80A0E9");
                }}
              >
        ...
        <div className="btn_next">
          <button onClick={() => setbedType("Bolster")}>Next Step</button>
        </div>
      </div>
    </div>
  );
