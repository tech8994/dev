...
export const FittedSheet = ({ setFittedSheetColor, setbedType }) => {
    ...
    <div className="duvet_cover">
      <div className="nested_duvet_Cover">
            ...
            <ul>
              ...
              <li
                ...
                onClick={() => {
                  ...
                  setFittedSheetColor("#AD542D");
                }}
                // onClick={() => setFittedSheetColor("#AD542D")}
              >
        ...
        <div className="btn_next">
          <button  onClick={() => setbedType("Flat Sheet")}>Next Step</button>
        </div>
      </div>
    </div>
  );
